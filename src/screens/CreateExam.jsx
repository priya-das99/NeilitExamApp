...
const CreateExam = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const combinedStart = getCombinedDateTime(startDate, startTime);
      const combinedEnd = getCombinedDateTime(endDate, endTime);
      
      // 1. Create exam and get the new exam's $id
      ...
      // Create exam (let Appwrite generate the $id)
